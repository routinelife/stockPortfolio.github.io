      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { className: 'mx-2', name: 'shares_owned', type: 'number', placeholder: 'Shares', onChange: this.handleFormChange, value: form.shares_owned, required: true }),
            React.createElement('input', { className: 'mx-2', name: 'cost_per_share', type: 'number', placeholder: 'Cost', onChange: this.handleFormChange, value: form.cost_per_share, required: true }),
            React.createElement('input', { className: 'mx-2', name: 'market_price', type: 'number', placeholder: 'Price', onChange: this.handleFormChange, value: form.market_price, required: true }),
            React.createElement(
              'button',
